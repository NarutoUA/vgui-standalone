...
Scheme
{
	...
	Colors
	{
		...
		"DisabledText2"		"100 100 100 255"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"117 134 102 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"25 25 25 255"		// background color of controls
		"ControlDarkBG"		"15 15 15 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"20 20 20 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"30 30 30 255"	// background color of any selected text or menu item
		"SelectionBG2"		"40 40 40 255"		// selection background in window w/o focus
		"ListBG"			"60 60 60 255"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"255 255 255 255"
		"TitleDimText"		"136 145 128 255"
		"TitleBG"			"10 10 10 0"
		"TitleDimBG"		"15 15 15 0"
		...
		// border colors
		"BorderBright"		"140 140 140 255"	// the lit side of a control
...
//		Slider.DisabledTextColor2	"30 30 30 255"
		...
		Tooltip.TextColor			"200 200 200 196"
